...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/20 20:31:53 by itorres-          #+#    #+#             */
/*   Updated: 2022/02/20 21:08:15 by itorres-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_matrix(char ptr[6] [6])
{
	int	count_x;
	int	count_y;
...
void	fill_borders(char *borders, char ptr[6][6])
{
		ptr[0][0] = '#';
		ptr[0][5] = '#';
		ptr[5][0] = '#';
...
void one_zero (char *c)
{
  ...
  c[zero_position] = 58 -sum;
}

void checker_only_one (char ptr[6][6]) 
{
